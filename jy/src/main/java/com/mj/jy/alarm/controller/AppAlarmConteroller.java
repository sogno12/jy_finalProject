	...
	public ResponseEntity readAlarms(@SessionAttribute("loginUser") MemberDto loginUser) {
		...
		// 2. EmpNo에 따른 6가지 각각의 알림갯수
			...
			if(eachAlarm != null && eachAlarm.length == 7) {
				...
				if(loginUser.getDepartmentNo() == 1 ) {
				text += "<a href='generalList.ge' class='link border-top'><div class='d-flex no-block align-items-center p-10'><span class='btn btn-danger btn-circle'><i class='fas fa-laptop'></i></span><div class='m-l-10'><h5 class='m-b-0'>회의실</h5><span class='mail-desc'>"+typeOne+"개의 신규알람</span></div></div></a>";
				text += "<a href='generalList.ge' class='link border-top'><div class='d-flex no-block align-items-center p-10'><span class='btn btn-info btn-circle'><i class='fas fa-id-badge'></i></span><div class='m-l-10'><h5 class='m-b-0'>명함</h5><span class='mail-desc'>"+typeTwo+"개의 신규알람</span></div></div></a>";
				}
				text += "<a href='messenger.me' class='link border-top'><div class='d-flex no-block align-items-center p-10'><span class='btn btn-warning btn-circle'><i class='fas fa-comment-alt'></i></span><div class='m-l-10'><h5 class='m-b-0'>쪽지</h5><span class='mail-desc'>"+typeFour+"개의 신규알람</span></div></div></a>";
