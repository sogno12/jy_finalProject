	...
	public ResponseEntity readAlarms(@SessionAttribute("loginUser") MemberDto loginUser) {
		...
		// 2. EmpNo에 따른 6가지 각각의 알림갯수
			...
			if(eachAlarm != null && eachAlarm.length == 7) {
				...
				text += "<a href='#' class='link border-top'><div class='d-flex no-block align-items-center p-10'><span class='btn btn-success btn-circle'><i class='ti-calendar'></i></span><div class='m-l-10'><h5 class='m-b-0'>결재변경</h5><span class='mail-desc'>"+typeFive+"개의 신규알람</span></div></div></a>";
				text += "<a href='#' class='link border-top'><div class='d-flex no-block align-items-center p-10'><span class='btn btn-success btn-circle'><i class='ti-calendar'></i></span><div class='m-l-10'><h5 class='m-b-0'>대기결재</h5><span class='mail-desc'>"+typeSix+"개의 신규알람</span></div></div></a>";
			}
