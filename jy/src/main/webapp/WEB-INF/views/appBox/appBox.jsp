...
<div id="main-wrapper">
	...
	<div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal">
                                <div class="card-body">
                                    <h4 class="card-title">보낸결재함</h4>
                                    <div class="table-responsive">
                                        <table id="myRequestTable" class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th scope="col">#</th>
                                            ...
                                            <tbody>
                                            	<c:choose>
                                            		<c:when test="${sendAppBox ne null}">
		                                            	<c:forEach var="sab" items="${sendAppBox}" >
			                                                <tr>
			                                                    <th scope="row"> # <input type="hidden" value='${ sab.categoryNo }' /> </th>
			                                                    <td>${ sab.no }</td>
			                                                    <td>${ sab.category }</td>
			                                                    <td>${ sab.title }</td>
			                                                    <td>${ sab.name }</td>
			                                                    <td>
			                                                    	<fmt:formatDate value="${sab.createDate}" pattern="yyyy-MM-dd HH:mm"/>
			                                                    </td>
			                                                    <td>${ sab.type }</td>
			                                                </tr>
		                                                </c:forEach>
                ...
                <div class="row" id="myEndRequestTableForm">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal">
                                <div class="card-body">
                                    <h4 class="card-title">결재종료함</h4>
                                    <div class="table-responsive">
                                        <table id="myEndRequestTable" class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">상신자</th>
                                                    <th scope="col">상신일자</th>
                                                    <th scope="col">결재결정</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            	<c:choose>
                                            		<c:when test="${endSentAppBox ne null}">
		                                            	<c:forEach var="sab" items="${endSentAppBox}" >
			                                                <tr>
			                                                    <th scope="row"> # <input type="hidden" value='${ sab.categoryNo }' /> </th>
			                                                    <td>${ sab.no }</td>
			                                                    <td>${ sab.category }</td>
                ...
                <div class="row" id="endRequetedTableForm">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal">
                                <div class="card-body">
                                    <h4 class="card-title">승인완료함</h4>
                                    <div class="table-responsive">
                                        <table id="endRequetedTable" class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th scope="col">#</th>
                                                    <th scope="col">문서번호</th>
                                            ...
                                            <tbody>
                                                <c:choose>
                                            		<c:when test="${receiveAppBox ne null}">
		                                            	<c:forEach var="rab" items="${endReceiveAppBox}" >
			                                                <tr>
			                                                    <th scope="row"> # <input type="hidden" value='${ rab.categoryNo }' /> </th>
			                                                    <td>${ rab.no }</td>
			                                                    <td>${ rab.category }</td>
    ...
    $(document).ready(function(){
        $('#myRequestTableForm').show();
        $('#myEndRequestTableForm').hide();
        $('#requestedTableForm').hide();
        $('#endRequetedTableForm').hide();
    });
    ...
    $('#myEndRequestBtn').click(function(){
        $('#myRequestTableForm').hide();
        $('#myEndRequestTableForm').show();
        $('#requestedTableForm').hide();
        $('#endRequetedTableForm').hide();
    });
     ...
     ****************************************/
     ...
     $('#myEndRequestTable').DataTable({
        "lengthMenu": [[5, 10, 15, -1], [5, 10, 15, "All"]]
     });
     $('#requestedTable').DataTable({
        "lengthMenu": [[5, 10, 15, -1], [5, 10, 15, "All"]]
     });
     $('#endRequetedTable').DataTable({
        "lengthMenu": [[5, 10, 15, -1], [5, 10, 15, "All"]]
     });
